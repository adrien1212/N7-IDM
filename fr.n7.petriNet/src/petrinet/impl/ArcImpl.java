...
public class ArcImpl extends PetriElementImpl implements Arc {
	...
	public void setTarget(Noeud newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, PetrinetPackage.NOEUD__INCOMING, Noeud.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, PetrinetPackage.NOEUD__INCOMING, Noeud.class, msgs);
