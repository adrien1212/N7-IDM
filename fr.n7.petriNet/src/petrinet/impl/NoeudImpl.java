 ...
 *   <li>{@link petrinet.impl.NoeudImpl#getIncoming <em>Incoming</em>}</li>
...
public abstract class NoeudImpl extends PetriElementImpl implements Noeud {
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NOEUD__INCOMING, PetrinetPackage.ARC__TARGET);
		}
		return incoming;
	}
